...
const Actions = function () {
  ...
  /**
   * @description Create Random wizeline mail
   * @method createRandomMail
   *
   */
  this.createRandomMail = () => {


      var random = Math.random().toString(36).substring(2, 15) + '.' + Math.random().toString(36).substring(2, 15)+'@'+Math.random().toString(36).substring(2,4)+'.wizeline.com';
      return random
  };
  ...
  this.selectCheck = (className,value) => {

   element(by.cssContainingText(className,value)).click();
