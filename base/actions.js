...
const Actions = function () {
   ...
   * @param {String} value
   */
  this.selectByValue = function (element, value) {
    var isSelectPresent = EC.presenceOf(element);
    var locator = "option[value='" + value + "']"
    browser.wait(isSelectPresent, 30000);
    element.click();
    element.element(by.css(locator)).click();
  };
}
