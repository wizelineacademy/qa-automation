...
const Actions = function (elementFinder) {
     ...
     * @param {webElement}  element
     */
    this.clickToRadio= function (element) {
        var isVisible = EC.visibilityOf(element);
        browser.wait(isVisible, 30000, 'Element is not visible');
        element.click();
    };
    ...
    this.getElementText = function (element) {
        var isVisible = EC.elementToBeClickable(element);
